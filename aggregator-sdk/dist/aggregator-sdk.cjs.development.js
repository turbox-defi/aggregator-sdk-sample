...
var ethers = require('@ethersproject/contracts');
var networks = require('@ethersproject/networks');
var IUniswapV2Pair = _interopDefault(require('@uniswap/v2-core/build/IUniswapV2Pair.json'));
var multicall = require('ethers-multicall');
var lodash = require('lodash');
var IUniswapV2Router02 = _interopDefault(require('@uniswap/v2-periphery/build/IUniswapV2Router02.json'));
var IUniswapV2Factory = _interopDefault(require('@uniswap/v2-core/build/IUniswapV2Factory.json'));
...
var Token = /*#__PURE__*/function (_Currency) {
  ...
  Token.getETHToken = function getETHToken(chainId) {
    ...
    switch (chainId) {
      case exports.ChainId.BSCMAINNET:
      case exports.ChainId.BSCTESTNET:
        symbol = "BNB";
      ...
      case exports.ChainId.HECOMAINNET:
        symbol = "HT";
...
var TokenAmount = /*#__PURE__*/function (_CurrencyAmount) {
  ...
  TokenAmount.getTokenAmountByExact = function getTokenAmountByExact(token, amount) {
    var typedValueParsed = units.parseUnits(amount, token.decimals).toString(); //   if (typedValueParsed !== '0') {
...
var TOKEN_DECIMALS_CACHE = (_TOKEN_DECIMALS_CACHE = {}, _TOKEN_DECIMALS_CACHE[exports.ChainId.BSCMAINNET] = {
      ...
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 5:
              _context.next = 7;
              return new ethers.Contract(address, ERC20, provider).decimals().then(function (decimals) {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 7;
              return new ethers.Contract(address, IUniswapV2Pair.abi, provider).getReserves();
...
var ChainConfig = /*#__PURE__*/function () {
  function ChainConfig(chainId, rpcUrl, multicallAddress, newHarborRouterAddress, scanApiAddress, scanApiKey) {
    this.chainId = exports.ChainId.BSCMAINNET;
...
var ProviderUtil = /*#__PURE__*/function () {
  ...
  ProviderUtil.getMultiCallProvider = function getMultiCallProvider(chainId) {
    if (chainId === void 0) {
      chainId = exports.ChainId.BSCMAINNET;
    }

    multicall.setMulticallAddress(chainId, ChainConfig.getChainConfig(chainId).multicallAddress);
    return new multicall.Provider(ProviderUtil.getJsonRPCProvider(chainId));
  };
  ...
  ProviderUtil.getJsonRPCProvider = function getJsonRPCProvider(chainId) {
    ...
    return new providers.JsonRpcProvider(ChainConfig.getChainConfig(chainId).rpcUrl);
  };
...
TokenList.DAI = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0x1af3f329e8be154074d8769d1ffa4ee058b1dbc3', 18, 'DAI', 'Dai Stablecoin');
TokenList.BUSD = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0xe9e7cea3dedca5984780bafc599bd69add087d56', 18, 'BUSD', 'Binance USD');
TokenList.USDT = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0x55d398326f99059ff775485246999027b3197955', 18, 'USDT', 'Tether USD');
TokenList.EOS = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0x56b6fb708fc5732dec1afc8d8556423a2edccbd6', 18, 'EOS', 'EOS Token');
TokenList.DOT = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0x7083609fce4d1d8dc0c979aab8c869ea2c873402', 18, 'DOT', 'Polkadot Token');
TokenList.ETH = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0x2170ed0880ac9a755fd29b2688956bd959f933f8', 18, 'ETH', 'Ethereum Token');
TokenList.WBNB = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c', 18, 'WBNB', 'Wrapped BNB');
TokenList.FRIES = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0x393b312c01048b3ed2720bf1b090084c09e408a1', 18, 'FRIES', 'fry.world');
TokenList.BURGER = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0xae9269f27437f0fcbc232d39ec814844a51d6b8f', 18, 'BURGER', 'Burger Swap');
TokenList.BAI = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0xaA8012a0Ea627767545a8E435C2A2BD51f60173D', 18, 'BAI', 'BAI Stablecoin');
TokenList.BAKE = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0xe02df9e3e622debdd69fb838bb799e3f168902c5', 18, 'BAKE', 'Bakery Token');
TokenList.BTCB = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0x7130d2a12b9bcbfae4f2634d864a1ee1ce3ead9c', 18, 'BTCB', 'BTCB Token');
TokenList.BAND = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0xad6caeb32cd2c308980a548bd0bc5aa4306c6c18', 18, 'BAND', 'BAND Protocol Token');
TokenList.XRP = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0x1d2f0da169ceb9fc7b3144628db156f3f6c60dbe', 18, 'XRP', 'XRP Token');
TokenList.BCH = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0x8ff795a6f4d97e7887c79bea79aba5cc76444adf', 18, 'BCH', 'Bitcoin Cash Token');
TokenList.LTC = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0x4338665cbb7b2485a8855a139b75d5e34ab0db94', 18, 'LTC', 'Litecoin Token');
TokenList.ADA = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0x3ee2200efb3400fabb9aacf31297cbdd1d435d47', 18, 'ADA', 'Cardano Token');
TokenList.CAKE = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82', 18, 'CAKE', 'PancakeSwap Token');
TokenList.THUGS = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0xE10e9822A5de22F8761919310DDA35CD997d63c0', 18, 'THUGS', 'THUGS');
TokenList.NYA = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0xbfa0841f7a90c4ce6643f651756ee340991f99d5', 18, 'NYA', 'Nyanswop Token');
TokenList.TWT = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0x4b0f1812e5df2a09796481ff14017e6005508003', 18, 'TWT', 'Trust Wallet');
TokenList.FUEL = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0x2090c8295769791ab7A3CF1CC6e0AA19F35e441A', 18, 'FUEL', 'FUEL');
TokenList.QUSD = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0xb8C540d00dd0Bf76ea12E4B4B95eFC90804f924E', 18, 'QUSD', 'QUSD Stablecoin');
TokenList.BANANA = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0x603c7f932ED1fc6575303D8Fb018fDCBb0f39a95', 18, 'BANANA', 'Ape like banana');
TokenList.ICREAM = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0x58f651DDE51CAa87c4111B16ee0A6Fab061Ee564', 18, 'ICREAM', 'Ice Cream');
TokenList.USDC = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0x8ac76a51cc950d9822d68b83fe1ad97b32cd580d', 18, 'USDC', 'Binance-Peg USD Coin');
TokenList.KUN = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0x1A2fb0Af670D0234c2857FaD35b789F8Cb725584', 18, 'KUN', 'Qian Governance Token');
TokenList.VAI = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0x4BD17003473389A42DAF6a0a729f6Fdb328BbBd7', 18, 'VAI', 'VAI');
TokenList.UST = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0x23396cF899Ca06c4472205fC903bDB4de249D6fC', 18, 'UST', 'UST');
TokenList.POKE = /*#__PURE__*/new Token(exports.ChainId.BSCMAINNET, '0xcdAd3683335a4a96d2c437Dd4513b061E4AEc4ff', 18, 'POKE', 'POKE');
TokenList.WHT = /*#__PURE__*/new Token(exports.ChainId.HECOMAINNET, '0x5545153ccfca01fbd7dd11c0b23ba694d9509a6f', 18, 'WHT', 'WHT Token');
TokenList.HUSD = /*#__PURE__*/new Token(exports.ChainId.HECOMAINNET, '0x0298c2b32eaE4da002a15f36fdf7615BEa3DA047', 8, 'HUSD', 'Heco USD');
TokenList.HUSDT = /*#__PURE__*/new Token(exports.ChainId.HECOMAINNET, '0xa71EdC38d189767582C38A3145b5873052c3e47a', 18, 'USDT', 'Tether USD');
TokenList.HETH = /*#__PURE__*/new Token(exports.ChainId.HECOMAINNET, '0x64ff637fb478863b7468bc97d30a5bf3a428a1fd', 18, 'ETH', 'Ethereum Token');
TokenList.BUSD_BSC_TEST = /*#__PURE__*/new Token(exports.ChainId.BSCTESTNET, '0xed24fc36d5ee211ea25a80239fb8c4cfd80f12ee', 18, 'BUSD', 'Binance USD');
TokenList.USDT_BSC_TEST = /*#__PURE__*/new Token(exports.ChainId.BSCTESTNET, '0x337610d27c682e347c9cd60bd4b3b107c9d34ddd', 18, 'USDT', 'Tether USD');
TokenList.ETH_BSC_TEST = /*#__PURE__*/new Token(exports.ChainId.BSCTESTNET, '0xd66c6B4F0be8CE5b39D52E0Fd1344c389929B378', 18, 'ETH', 'ETH');
...
})(exports.DexType || (exports.DexType = {}));
...
})(exports.DexSubType || (exports.DexSubType = {}));
...
var DexFactory = /*#__PURE__*/function () {
  function DexFactory(name, factoryAddress, initCodeHash, baseFee, interToken, routerAddress, chainId, type, config, subType) {
    ...
    if (type === void 0) {
      type = exports.DexType.UniswapV2;
    }
    ...
    if (subType === void 0) {
      subType = exports.DexSubType.UniswapV2ETH;
    }

    this.config = {};
    this.subType = exports.DexSubType.UniswapV2ETH;
    this.name = name;
  ...
  _proto.swapCallParameters = function swapCallParameters(trade, options) {
    ...
    switch (trade.tradeType) {
      case exports.TradeType.EXACT_INPUT:
        if (etherIn) {
          if (this.subType == exports.DexSubType.UniswapV2ETH) {
            methodName = useFeeOnTransfer ? 'swapExactETHForTokensSupportingFeeOnTransferTokens' : 'swapExactETHForTokens';
          } else {
            if (this.subType == exports.DexSubType.UniswapV2BURGER) {
              methodName = "swapExactETHForTokens";
            } else if (this.subType == exports.DexSubType.UniswapV2HT) {
  ...
  _proto.getRouter02Json = function getRouter02Json() {
    ...
    } else if (this.subType == exports.DexSubType.UniswapV2BURGER) {
      return IUniswapV2Router02ForBurger.abi;
    } else if (this.type == exports.DexType.Acryptos) {
      return ACSPool.abi;
    } else if (this.subType == exports.DexSubType.UniswapV2HT) {
    ...
    var _fetchDexFactoryAddress = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
      ...
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              contract = new ethers.Contract(this.routerAddress, this.getRouter02Json(), ProviderUtil.getJsonRPCProvider(this.chainId));
              _context.next = 3;
...
DexFactory.PANCAKESWAP_TEST = /*#__PURE__*/new DexFactory("PancakeSwapTest", "0xBCfCcbde45cE874adCB698cC183deBcF17952812", "0xd0d4c4cd0848c93cb4fd1f498d7013ee6bfb25783ea21593d5834f5d250ece66", PERCENT_02, DexFactory.BASE_INTER_TOKEN, "0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F", exports.ChainId.BSCTESTNET);
...
DexFactory.BAKERYSWAP = /*#__PURE__*/new DexFactory("BakerySwap", "0x01bF7C66c6BD861915CdaaE475042d3c4BaE16A7", "", PERCENT_03, [TokenList.BAI, TokenList.USDT, TokenList.BUSD, TokenList.DAI, TokenList.WBNB], "0xCDe540d7eAFE93aC5fE6233Bee57E1270D3E330F", exports.ChainId.BSCMAINNET, exports.DexType.UniswapV2, {}, exports.DexSubType.UniswapV2BNB);
DexFactory.BSCSWAP = /*#__PURE__*/new DexFactory("BscSwap", "0xCe8fd65646F2a2a897755A1188C04aCe94D2B8D0", "", PERCENT_03, [TokenList.BAI, TokenList.USDT, TokenList.BUSD, TokenList.DAI, TokenList.WBNB], "0xd954551853F55deb4Ae31407c423e67B1621424A", exports.ChainId.BSCMAINNET, exports.DexType.UniswapV2, {}, exports.DexSubType.UniswapV2BNB);
DexFactory.JULSWAP = /*#__PURE__*/new DexFactory("JulSwap", "0x553990F2CBA90272390f62C5BDb1681fFc899675", "0xb1e98e21a5335633815a8cfb3b580071c2e4561c50afd57a8746def9ed890b18", PERCENT_03, [TokenList.USDT, TokenList.BUSD, TokenList.DAI, TokenList.WBNB], "0xbd67d157502A23309Db761c41965600c2Ec788b2", exports.ChainId.BSCMAINNET, exports.DexType.UniswapV2, {}, exports.DexSubType.UniswapV2BNB);
DexFactory.SOFTDRINKSWAP = /*#__PURE__*/new DexFactory("SoftDrinkSwap", "0xbcaE2c6cB2477fCcF75d0b0c4e6059Da00c4086a", "0xe0d22d674b32bd59ffdb3afe16b141394eaba6ffb2d2e8d8329eabde70d606a1", PERCENT_03, [TokenList.USDT, TokenList.BUSD, TokenList.DAI, TokenList.WBNB], "0x7833f7d66248E4fbD705CD83DcC74288ff98d313", exports.ChainId.BSCMAINNET, exports.DexType.UniswapV2, {}, exports.DexSubType.UniswapV2ETH);
DexFactory.SWAPKING = /*#__PURE__*/new DexFactory("SwapKing", "0x14a19EDcb52bcb2c94FCf34c6bbAf28A0A328912", "", PERCENT_03, [TokenList.USDT, TokenList.BUSD, TokenList.DAI, TokenList.WBNB], "0x3214ed1aefc609b22e02fc299618b40e8cf53e1d", exports.ChainId.BSCMAINNET, exports.DexType.UniswapV2, {}, exports.DexSubType.UniswapV2ETH);
DexFactory.BAMBOOSWAP = /*#__PURE__*/new DexFactory("BambooSwap", "0xD5Da6ea22EF4c69ED0bea50fc03Df6c561c5573F", "", PERCENT_03, [TokenList.USDT, TokenList.BUSD, TokenList.DAI, TokenList.WBNB], "007ace54baa6e841797f1e85d0170483775be47aea", exports.ChainId.BSCMAINNET, exports.DexType.UniswapV2, {}, exports.DexSubType.UniswapV2ETH);
DexFactory.STORMSWAP = /*#__PURE__*/new DexFactory("StormSwap", "0x720767Aea828a9730123679f3cE3DE01369b4575", "0x72bef119148700d90368b970fce6840043d95e856d185214cc25bfcf11c88825", PERCENT_03, [TokenList.USDT, TokenList.BUSD, TokenList.DAI, TokenList.WBNB], undefined, exports.ChainId.BSCMAINNET, exports.DexType.UniswapV2, {}, exports.DexSubType.UniswapV2BNB);
DexFactory.NARWHALSWAP = /*#__PURE__*/new DexFactory("NarwhalSwap", "0xB9fA84912FF2383a617d8b433E926Adf0Dd3FEa1", "0x8a30072f74333632d4cca8ddbfc623703398716ee4a6a93f48d4fc610b5b4cf4", PERCENT_03, [TokenList.USDT, TokenList.BUSD, TokenList.DAI, TokenList.WBNB], "0xE85C6ab56A3422E7bAfd71e81Eb7d0f290646078", exports.ChainId.BSCMAINNET, exports.DexType.UniswapV2, {}, exports.DexSubType.UniswapV2BNB);
DexFactory.NYANSWOP = /*#__PURE__*/new DexFactory("NyanSwop", "0xF38D202723a9376C034eD5b8Cecb4EFe8f249836", "", PERCENT_03, [TokenList.USDT, TokenList.BUSD, TokenList.DAI, TokenList.WBNB, TokenList.NYA], "0xc946764369623F560a5962D32c1D16D45F1BD6fa", exports.ChainId.BSCMAINNET, exports.DexType.UniswapV2, {}, exports.DexSubType.UniswapV2BNB);
...
DexFactory.VALUEDEFI = /*#__PURE__*/new DexFactory("ValueDefi", "0x1B8E12F839BD4e73A47adDF76cF7F0097d74c14C", "", PERCENT_03, [TokenList.USDT, TokenList.BUSD, TokenList.WBNB], "0xb7e19a1188776f32E8C2B790D9ca578F2896Da7C", exports.ChainId.BSCMAINNET, exports.DexType.UniswapV2, {}, exports.DexSubType.UniswapV2ETH);
DexFactory.MDEX_BSC = /*#__PURE__*/new DexFactory("MDEX-BSC", "0x3CD1C46068dAEa5Ebb0d3f55F6915B10648062B8", "0x0d994d996174b05cfc7bed897dc1b20b4c458fc8d64fe98bc78b3c64a6b4d093", PERCENT_03, [TokenList.USDT, TokenList.BUSD, TokenList.DAI, TokenList.WBNB], "0x7DAe51BD3E3376B8c7c4900E9107f12Be3AF1bA8", exports.ChainId.BSCMAINNET, exports.DexType.UniswapV2, {}, exports.DexSubType.UniswapV2ETH);
...
DexFactory.ACS4QUSD = /*#__PURE__*/new DexFactory("ACS4QUSD", "", "", PERCENT_03, [], "0x3919874C7bc0699cF59c981C5eb668823FA4f958", exports.ChainId.BSCMAINNET, exports.DexType.Acryptos, (_DexFactory = {}, _DexFactory["coins"] = [TokenList.QUSD, TokenList.BUSD, TokenList.USDT, TokenList.DAI, TokenList.USDC], _DexFactory["N_COINS"] = 2, _DexFactory["base_pool"] = "0xb3f0c9ea1f05e312093fdb031e789a756659b0ac", _DexFactory["N_BASE_COINS"] = 4, _DexFactory["lp_token"] = "0x83d69ef5c9837e21e2389d47d791714f5771f29b", _DexFactory), exports.DexSubType.AcryptoS);
DexFactory.ACS4VAI = /*#__PURE__*/new DexFactory("ACS4VAI", "", "", PERCENT_03, [], "0x191409D5A4EfFe25b0f4240557BA2192D18a191e", exports.ChainId.BSCMAINNET, exports.DexType.Acryptos, (_DexFactory2 = {}, _DexFactory2["coins"] = [TokenList.VAI, TokenList.BUSD, TokenList.USDT, TokenList.DAI, TokenList.USDC], _DexFactory2["N_COINS"] = 2, _DexFactory2["base_pool"] = "0xb3f0c9ea1f05e312093fdb031e789a756659b0ac", _DexFactory2["N_BASE_COINS"] = 4, _DexFactory2["lp_token"] = "0x83d69ef5c9837e21e2389d47d791714f5771f29b", _DexFactory2), exports.DexSubType.AcryptoS);
DexFactory.ACS4UST = /*#__PURE__*/new DexFactory("ACS4UST", "", "", PERCENT_03, [], "0x99c92765EfC472a9709Ced86310D64C4573c4b77", exports.ChainId.BSCMAINNET, exports.DexType.Acryptos, (_DexFactory3 = {}, _DexFactory3["coins"] = [TokenList.UST, TokenList.BUSD, TokenList.USDT, TokenList.DAI, TokenList.USDC], _DexFactory3["N_COINS"] = 2, _DexFactory3["base_pool"] = "0xb3f0c9ea1f05e312093fdb031e789a756659b0ac", _DexFactory3["N_BASE_COINS"] = 4, _DexFactory3["lp_token"] = "0x83d69ef5c9837e21e2389d47d791714f5771f29b", _DexFactory3), exports.DexSubType.AcryptoS);
DexFactory.MDEX = /*#__PURE__*/new DexFactory("MDEX", "0xb0b670fc1F7724119963018DB0BfA86aDb22d941", "0x2ad889f82040abccb2649ea6a874796c1601fb67f91a747a80e08860c73ddf24", PERCENT_03, [TokenList.HUSDT, TokenList.HUSD, TokenList.WHT], "0xED7d5F38C79115ca12fe6C0041abb22F0A06C300", exports.ChainId.HECOMAINNET);
DexFactory.LAVASWAP = /*#__PURE__*/new DexFactory("LavaSwap", "0x1EA26C17d061E8a7Cc33B20d8d8Dad131d7fb392", "", PERCENT_03, [TokenList.HUSDT, TokenList.HUSD, TokenList.WHT], "0xe38623b265b5acc9f35e696381769e556ed932f9", exports.ChainId.HECOMAINNET);
DexFactory.DOGESWAP = /*#__PURE__*/new DexFactory("DogeSwap", "0x0419082bb45f47fe5c530ea489e16478819910f3", "0x06d32be9fe9b1c75a1ce7e2b362c735bcb731596b9330b99412fde52d753e3f0", PERCENT_03, [TokenList.HUSDT, TokenList.HUSD, TokenList.WHT], "0x539A9Fbb81D1D2DC805c698B55C8DF81cbA6b350", exports.ChainId.HECOMAINNET, exports.DexType.UniswapV2, {}, exports.DexSubType.UniswapV2ETH);
DexFactory.MDIS = /*#__PURE__*/new DexFactory("MDIS", "0x2F3F03b6a1B1d73b01390E234AE813bc06d5B8e8", "0xc5a24d8158ef97c42050dd7ff53c64db08633f3aa6250cc47b90e63eaeddb4ff", PERCENT_03, [TokenList.HUSDT, TokenList.HUSD, TokenList.WHT], "0x40367258BB8b9195446E99079391D7Ccb5AaeaB9", exports.ChainId.HECOMAINNET, exports.DexType.UniswapV2, {}, exports.DexSubType.UniswapV2ETH);
DexFactory.UNISAVE = /*#__PURE__*/new DexFactory("Unisave", "0x32CE36F6eA8d97f9fC19Aab83b9c6D2F52D74470", "0xc5a24d8158ef97c42050dd7ff53c64db08633f3aa6250cc47b90e63eaeddb4ff", PERCENT_03, [TokenList.HUSDT, TokenList.HUSD, TokenList.WHT], "0x039B5818e51dfEC86c1D56A4668787AF0Ed1c068", exports.ChainId.HECOMAINNET, exports.DexType.UniswapV2, {}, exports.DexSubType.UniswapV2ETH);
DexFactory.PIPPISHRIMP = /*#__PURE__*/new DexFactory("PippiShrimp", "0x979efE7cA072b72d6388f415d042951dDF13036e", "0xd805d4c8a7fb3567167020352386905de5d4bd188fe2284675e3ed584653df75", PERCENT_03, [TokenList.HUSDT, TokenList.HUSD, TokenList.WHT], "0xBe4AB2603140F134869cb32aB4BC56d762Ae900B", exports.ChainId.HECOMAINNET, exports.DexType.UniswapV2, {}, exports.DexSubType.UniswapV2ETH);
...
DexFactory.CIRCLESWAP = /*#__PURE__*/new DexFactory("CircleSwap", "0xB49f19289857f4499781AaB9afd4A428C4BE9CA8", "", PERCENT_035, [TokenList.HUSDT, TokenList.HUSD, TokenList.WHT], "0xecEAb8fAd5fD9b61b473007C749957cBB1A14D04", exports.ChainId.HECOMAINNET, exports.DexType.UniswapV2, {}, exports.DexSubType.UniswapV2ETH);
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              basePairs = lodash.flatMap(bases, function (base) {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              contract = new ethers.Contract(dexFactory.factoryAddress, IUniswapV2Factory.abi, ProviderUtil.getJsonRPCProvider(dexFactory.chainId));
              _context2.next = 5;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 16:
              //只要有一个没中，全部从链上查询
              result = [];
              contract = new multicall.Contract(dexFactory.factoryAddress, IUniswapV2Factory.abi);
            ...
            case 10:
              ...
              for (_i in addresses) {
                ...
                if (address != ADDRESS_NULL) {
                  contract = new multicall.Contract(address, IUniswapV2Pair.abi);
      ...
      return runtime_1.wrap(function _callee7$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            ...
            case 5:
              factoryContract = new ethers.Contract(dexFactory.factoryAddress, IUniswapV2Factory.abi, ProviderUtil.getJsonRPCProvider(dexFactory.chainId));
              _context8.next = 8;
            ...
            case 8:
              ...
              mcFactoryContract = new multicall.Contract(dexFactory.factoryAddress, IUniswapV2Factory.abi);
              calls = [];
              MULTICALL_MAX = 100;
              callCount = 0;
              result = [];
                    ...
                    switch (_context7.prev = _context7.next) {
                      ...
                      case 5:
                        ...
                        for (_iterator3 = _createForOfIteratorHelperLoose(pairAddresses); !(_step3 = _iterator3()).done;) {
                          ...
                          mcPairContract = new multicall.Contract(address, IUniswapV2Pair.abi);
                          ...
                          return runtime_1.wrap(function _loop$(_context6) {
                            while (1) {
                              switch (_context6.prev = _context6.next) {
                                ...
                                case 10:
                                  tokenContract = new ethers.Contract(tokenAddresses[i], ERC20, ProviderUtil.getJsonRPCProvider(dexFactory.chainId));
                                  _context6.next = 13;
                                ...
                                case 31:
                                  _tokenContract = new ethers.Contract(tokenAddresses[i + 1], ERC20, ProviderUtil.getJsonRPCProvider(dexFactory.chainId));
                                  _context6.next = 34;
...
var ACryptoS = /*#__PURE__*/function () {
    ...
    var _getBestTradeExactIn = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(tokenIn, amountIn, tokenOut, dexFactory) {
      ...
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              !(dexFactory.type == exports.DexType.Acryptos) ?  invariant(false, "Must be ACryptoS Dex")  : void 0;
              inputAmount = TokenAmount.getTokenAmountByExact(tokenIn, amountIn);
              i = ACryptoS.getTokenIndex(tokenIn, dexFactory);
              !(i >= 0) ?  invariant(false, tokenIn.symbol + " is not supported")  : void 0;
              j = ACryptoS.getTokenIndex(tokenOut, dexFactory);
              !(j >= 0) ?  invariant(false, tokenOut.symbol + " is not supported")  : void 0;
              dx = bignumber.BigNumber.from(inputAmount.raw.toString());
              contract = new ethers.Contract(dexFactory.routerAddress, dexFactory.getRouter02Json(), ProviderUtil.getJsonRPCProvider(dexFactory.chainId));
              _context.next = 10;
  ...
  ACryptoS.getBestTradeExactInStatic = function getBestTradeExactInStatic(tokenIn, amountIn, tokenOut, dexFactory, curvePool) {
    ...
    !(j >= 0) ?  invariant(false, tokenOut.symbol + " is not supported")  : void 0;
    var dx = bignumber.BigNumber.from(inputAmount.raw.toString());
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              !(trade.dex.type == exports.DexType.Acryptos) ?  invariant(false, "Must be ACryptoS Dex")  : void 0;
              i = ACryptoS.getTokenIndex(trade.tokenIn, trade.dex);
              !(i >= 0) ?  invariant(false, trade.tokenIn.symbol + " is not supported")  : void 0;
              j = ACryptoS.getTokenIndex(trade.tokenOut, trade.dex);
              !(j >= 0) ?  invariant(false, trade.tokenOut.symbol + " is not supported")  : void 0;
              dx = bignumber.BigNumber.from(trade.amountIn.raw.toString());
              min_dy = bignumber.BigNumber.from(trade.minimumAmountOut.raw.toString());
              routerContract = new ethers.Contract(trade.dex.routerAddress, trade.dex.getRouter02Json(), wallet.getSignerOrProvider());
              _context2.next = 11;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (!(dexFactory.type == exports.DexType.UniswapV2)) {
                _context.next = 9;
                break;
              }
            ...
            case 9:
              if (!(dexFactory.type == exports.DexType.Acryptos)) {
                _context.next = 11;
                break;
              }
...
var WalletUtil = /*#__PURE__*/function () {
  ...
  WalletUtil.getTokenContract = function getTokenContract(token) {
    return new ethers.Contract(token.address, ERC20, ProviderUtil.getJsonRPCProvider(token.chainId));
  };
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              contract = new ethers.Contract(token.address, ERC20, wallet.getSignerOrProvider());
              _context3.next = 4;
          ...
          switch (_context4.prev = _context4.next) {
            ...
            case 9:
              ...
              for (i = 0; i < allTokens.length; i++) {
                token = allTokens[i];
                multiContract = new multicall.Contract(token.address, ERC20);
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (!(trade.dex.type == exports.DexType.UniswapV2)) {
                _context.next = 39;
                break;
              }
            ...
            case 9:
              ...
              !trade.dex.isAutoSwapSupported() ?  invariant(false, "ROUTER_ADDRESS")  : void 0;
            ...
            case 39:
              if (!(trade.dex.type == exports.DexType.Acryptos)) {
                _context.next = 43;
                break;
              }
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              !trade.dex.isAutoSwapSupported() ?  invariant(false, "AUTO SWAP NOT SUPPORTED")  : void 0;
            ...
            case 13:
              ...
              !JSBI.greaterThanOrEqual(JSBI.BigInt(inBalanceBefore.toString()), trade.amountIn.raw) ?  invariant(false, "NO ENOUGH BALANCE")  : void 0;
              _context2.next = 17;
              return WalletUtil.getBalance(wallet, trade.tokenOut);

            case 17:
              outBalanceBefore = _context2.sent;
              console.log(nowTimeString() + " " + trade.tokenOut.symbol + " balance before trade: " + units.formatEther(outBalanceBefore) + " " + trade.tokenOut.symbol);
            ...
            case 67:
              ...
              console.log(nowTimeString() + " " + trade.tokenOut.symbol + " balance after trade: " + units.formatEther(outBalanceAfter) + " " + trade.tokenOut.symbol);
              gap = outBalanceAfter.sub(outBalanceBefore);
              console.log(nowTimeString() + " Actual received：" + units.formatEther(gap) + " " + trade.tokenOut.symbol);
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              !apiUrl ?  invariant(false, "Scan API adddress not set")  : void 0;
            ...
            case 9:
              ...
              for (_iterator = _createForOfIteratorHelperLoose(json.data.result); !(_step = _iterator()).done;) {
                ...
                result.push({
                  ...
                  gasLimit: bignumber.BigNumber.from(t.gas),
                  gasPrice: bignumber.BigNumber.from(t.gasPrice),
                  data: t.input,
                  value: bignumber.BigNumber.from(t.value),
                  chainId: chainId
                });
              }
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 8:
              ...
              inter = new abi$6.Interface(ERC20); // console.log(transactions);
            ...
            case 23:
              ...
              sumReceiveAmt = bignumber.BigNumber.from(0);
            ...
            case 49:
              ...
              return _context.abrupt("return", bignumber.BigNumber.from(0));
    ...
    var _wrapWETH = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(wallet, amount, chainId) {
      ...
      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              contract = new ethers.Contract(WETH == null ? void 0 : WETH[chainId].address, WETH_ABI, wallet.getSignerOrProvider());
              console.log(nowTimeString() + " Wrap " + units.formatEther(amount) + " " + Token.getETHToken(chainId).symbol + " to " + (WETH == null ? void 0 : WETH[chainId].symbol));
              _context2.next = 4;
      ...
      return runtime_1.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              contract = new ethers.Contract(WETH == null ? void 0 : WETH[chainId].address, WETH_ABI, wallet.getSignerOrProvider());
              console.log(nowTimeString() + " Unwrap " + units.formatEther(amount) + " " + (WETH == null ? void 0 : WETH[chainId].symbol) + " to " + Token.getETHToken(chainId).symbol);
              _context3.next = 4;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              tokenContract = new ethers.Contract(isAddressSearch, ERC20, ProviderUtil.getJsonRPCProvider(chainId));
              _context4.next = 5;
              return tokenContract.symbol();
...
var DEFAULT_DEX = (_DEFAULT_DEX = {}, _DEFAULT_DEX[exports.ChainId.BSCMAINNET] = DexFactory.PANCAKESWAP, _DEFAULT_DEX[exports.ChainId.HECOMAINNET] = DexFactory.MDEX, _DEFAULT_DEX[exports.ChainId.BSCTESTNET] = DexFactory.PANCAKESWAP_TEST, _DEFAULT_DEX);
var ETH_PRICE_CACHE;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 5:
            ...
            price = bignumber.BigNumber.from(trade.outputAmount.raw.toString());
            console.log("Current " + WETH[toToken.chainId].symbol + " price：1 " + WETH[toToken.chainId].symbol + "=" + units.formatUnits(price, toToken.decimals) + toToken.symbol);
...
var ArbiPlan = /*#__PURE__*/function () {
  function ArbiPlan(trades) {
    this.trades = [];
    !(trades.length > 0) ?  invariant(false, "TRADES LENGTH ZERO")  : void 0;
    this.trades = trades;
  }
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              !(trade1 != null) ?  invariant(false, "TRADE1")  : void 0;
            ...
            case 8:
              ...
              !(trade2 != null) ?  invariant(false, "TRADE2")  : void 0; // const finalOut=trade2.minimumAmountOut(dex2.allowedSlippage);
...
var AggSwapRoute = /*#__PURE__*/function () {
  function AggSwapRoute(inputAmount, tokens, distributions) {
    !(tokens.length >= 2) ?  invariant(false, "At least 2 tokens for a route")  : void 0;
    !(tokens.length - 1 == distributions.length) ?  invariant(false, "The length of tokens must match the length of dex distribution")  : void 0;
    this.inputAmount = inputAmount;
    this.tokens = tokens;
  ...
  _proto.checkDistributions = function checkDistributions() {
    for (var _iterator = _createForOfIteratorHelperLoose(this.distributions), _step; !(_step = _iterator()).done;) {
      var d = _step.value;
      !(d.length <= 16) ?  invariant(false, "The length of dex assign cant be greater than 16")  : void 0;
      var sum = 0;

      for (var _iterator2 = _createForOfIteratorHelperLoose(d), _step2; !(_step2 = _iterator2()).done;) {
        var da = _step2.value;
        !(da.percentage >= 0 && da.percentage <= 100) ?  invariant(false, "The percentage is illegal")  : void 0;
        sum += da.percentage;
      }

      !(sum == 100) ?  invariant(false, "The sum of percentage must be equal to 100")  : void 0;
    }
  };
  ...
  _proto.toSwapRouteParameter = function toSwapRouteParameter() {
    ...
    for (var _iterator3 = _createForOfIteratorHelperLoose(this.distributions), _step3; !(_step3 = _iterator3()).done;) {
      ...
      for (var _iterator4 = _createForOfIteratorHelperLoose(d), _step4; !(_step4 = _iterator4()).done;) {
        ...
        !(dexIndex != undefined) ?  invariant(false, "Dex is not supported")  : void 0;
      ...
      distStr = "0x" + distStr;
      distWrap.push(bignumber.BigNumber.from(distStr));
    }
...
var AggRouterSwapParameter = function AggRouterSwapParameter(splitAmount, routes, minReturnAmount, flags) {
  if (flags === void 0) {
    flags = bignumber.BigNumber.from(0);
  }
...
var AggSwapPlan = /*#__PURE__*/function () {
  function AggSwapPlan(swapRouteList, minReturnAmount, chainId) {
    ...
    !(swapRouteList.length >= 1) ?  invariant(false, "At least 1 swap route needed")  : void 0;
  ...
  _proto2.checkSwapRouteList = function checkSwapRouteList() {
    ...
    for (var _iterator5 = _createForOfIteratorHelperLoose(this.swapRouteList), _step5; !(_step5 = _iterator5()).done;) {
      var a = _step5.value;
      !a.fromToken.equals(fromToken) ?  invariant(false, "The first token of the swap routes must be same")  : void 0;
      !a.toToken.equals(toToken) ?  invariant(false, "The last token of the swap routes must be same")  : void 0;
    }
  };
      ...
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              if (callMode === void 0) {
                callMode = exports.CallMode.EXECUTE;
              }

              routeAddress = ChainConfig.getChainConfig(plan.chainId).newHarborRouterAddress;
              !(routeAddress != undefined && validateAndParseAddress(routeAddress)) ?  invariant(false, "Invalid router address")  : void 0;
              _context.next = 5;
              return WalletUtil.getBalance(wallet, plan.fromToken);

            case 5:
              inBalanceBefore = _context.sent;
              !inBalanceBefore.gte(plan.inputAmount) ?  invariant(false, "No enough balance")  : void 0;
              _context.next = 9;
              return WalletUtil.getBalance(wallet, plan.toToken);

            case 9:
              outBalanceBefore = _context.sent;
              console.log(nowTimeString() + " " + plan.toToken.symbol + " balance before trade: " + units.formatUnits(outBalanceBefore, plan.toToken.decimals) + " " + plan.toToken.symbol);
              contract = new ethers.Contract(routeAddress, NewHarborRouter.abi, wallet.getSignerOrProvider());
              ...
              if (!(callMode == exports.CallMode.EXECUTE)) {
                _context.next = 39;
                break;
              }
            ...
            case 31:
              ...
              console.log(nowTimeString() + " " + plan.toToken.symbol + " balance after trade: " + units.formatUnits(outBalanceAfter, plan.toToken.decimals) + " " + plan.toToken.symbol);
              gap = outBalanceAfter.sub(outBalanceBefore);
              gasFee = rpt.gasUsed.mul(tx.gasPrice);
              console.log(nowTimeString() + " Actual received：" + units.formatUnits(gap, plan.toToken.decimals) + " " + plan.toToken.symbol);
            ...
            case 39:
              if (!(callMode == exports.CallMode.CALL_STATIC)) {
                _context.next = 45;
                break;
              }
            ...
            case 42:
              return _context.abrupt("return", {
                gap: bignumber.BigNumber.from(0),
                gasFee: bignumber.BigNumber.from(0),
            ...
            case 54:
              ...
              console.log(nowTimeString() + " Estimated gas fee: " + units.formatEther(_gasFee));
              return _context.abrupt("return", {
                gap: bignumber.BigNumber.from(0),
                gasFee: _gasFee,
                gas: _gasLimit
...
var CurveBasePool = /*#__PURE__*/function () {
  function CurveBasePool(A, balances, tokens, lp_token_totalSupply, fee) {
    ...
    this.FEE_DENOMINATOR = bignumber.BigNumber.from(10).pow(10);
    this.balances = balances;
    this.N_COINS = tokens.length;
    this.MAX_COIN = this.N_COINS - 1;
    this.PRECISION = bignumber.BigNumber.from(10).pow(tokens[0].decimals);
    this.RATES = tokens.map(function (t) {
      return bignumber.BigNumber.from(10).pow(tokens[0].decimals);
    });
    this.PRECISION_MUL = tokens.map(function (t) {
      return 1;
    });
    this.A = bignumber.BigNumber.from(A);
  ...
  _proto._xp = function _xp() {
    ...
    var result = this.RATES.map(function (t) {
      return bignumber.BigNumber.from(t);
    });
  ...
  _proto.get_D = function get_D(xp, amp) {
    var S = bignumber.BigNumber.from(0);
    var Dprev = bignumber.BigNumber.from(0);
  ...
  _proto.calc_token_amount = function calc_token_amount(amounts, is_deposit) {
    ...
    var diff = bignumber.BigNumber.from(0);
  ...
  _proto.get_y = function get_y(i, j, x, xp_) {
    ...
    var Ann = amp.mul(this.N_COINS);
    var c = D;
    var S_ = bignumber.BigNumber.from(0);

    var _x = bignumber.BigNumber.from(0);

    var y_prev = bignumber.BigNumber.from(0);
  ...
  _proto._calc_withdraw_one_coin = function _calc_withdraw_one_coin(_token_amount, i) {
    ...
    for (var j = 0; j < this.N_COINS; j++) {
      var dx_expected = bignumber.BigNumber.from(0);
...
var CurvePool = /*#__PURE__*/function () {
  function CurvePool(basePool, A, balances, tokens, fee) {
    this.PRECISION = bignumber.BigNumber.from(10).pow(18);
    this.A_PRECISION = 100;
    this.FEE_DENOMINATOR = bignumber.BigNumber.from(10).pow(10);
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              for (_iterator3 = _createForOfIteratorHelperLoose(dexes); !(_step3 = _iterator3()).done;) {
                ...
                contract = new multicall.Contract(dexFactory.routerAddress, dexFactory.getRouter02Json());
                ...
                contract2 = new multicall.Contract(basePoolAddress, ACSBasePool.abi);
                ...
                lpTokenContract = new multicall.Contract(lpTokenAddress, ERC20);
    ...
    var _buildFromDexFactory = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(dexFactory) {
      ...
      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              !(dexFactory.type == exports.DexType.Acryptos) ?  invariant(false, "Must be Curve DEX")  : void 0;
...
var AggTokenGraph = /*#__PURE__*/function () {
                  ...
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      case 0:
                        ...
                        if (!(dex.type == exports.DexType.UniswapV2)) {
                          _context2.next = 34;
                          break;
                        }
                              ...
                              switch (_context.prev = _context.next) {
                                ...
                                case 8:
                                  ...
                                  temp.map(function (pairData) {
                                    ...
                                    console.log(j + 1 + " Loading pair [" + aggPair.token0.symbol + "," + aggPair.token1.symbol + "]: " + units.formatUnits(pairData.reserve0.raw.toString(), aggPair.token0.decimals) + "," + units.formatUnits(pairData.reserve1.raw.toString(), aggPair.token1.decimals));
                                  });
                      ...
                      case 34:
                        if (dex.type == exports.DexType.Acryptos) {
                          ...
                          for (_iterator3 = _createForOfIteratorHelperLoose(coins); !(_step3 = _iterator3()).done;) {
                            ...
                            for (_iterator4 = _createForOfIteratorHelperLoose(coins); !(_step4 = _iterator4()).done;) {
                              ...
                              if (!coin1.equals(coin2)) {
                                _aggPair = new AggPair(dex.name, coin1, coin2, units.parseUnits(default_reserve, coin1.decimals), units.parseUnits(default_reserve, coin2.decimals));
  ...
  _proto.getAvailableRoutesStatic = function getAvailableRoutesStatic(inputAmount, fromToken, toToken, maxDexHops, maxTokenHops, maxPriceImpactPercent, minReturn, execuldeDexes, maxResults, usedDexes, usedAggPairs) {
    ...
    if (bignumber.BigNumber.from(inputAmount).eq(0)) {
      return [];
    ...
    var _loop3 = function _loop3() {
      ...
      if (usedAggPairs.filter(function (p) {
        ...
        if (_this.aggPairOutputAmountStatic(aggPair, fromToken, bignumber.BigNumber.from(inputAmount)).gte(minReturn)) {
          result.push([aggPair]);
    ...
    var _loop4 = function _loop4() {
      ...
      if (usedAggPairs.filter(function (p) {
        ...
        var nextInputAmount = _this.aggPairOutputAmountStatic(aggPair, fromToken, bignumber.BigNumber.from(inputAmount));

        if (nextInputAmount.lte(0)) return "continue";

        var priceImpact = _this.aggPairPriceImpact(aggPair, fromToken, bignumber.BigNumber.from(inputAmount));
  ...
  _proto.getBestRoutesStatic = function getBestRoutesStatic(inputAmount, fromToken, toToken, maxDexHops, maxTokenHops, maxPriceImpactPercent, minReturn, execuldeDexes, maxResults) {
    ...
    for (var _iterator8 = _createForOfIteratorHelperLoose(route), _step8; !(_step8 = _iterator8()).done;) {
      ...
      result.push({
        route: r,
        outputAmount: this.aggPairRouteOutputAmountStatic(r, fromToken, bignumber.BigNumber.from(inputAmount))
      });
    }
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 12:
              ...
              _context4.prev = 17;
              _context4.next = 20;
              return AggRouter.swap(plan, wallet, exports.CallMode.CALL_STATIC);
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 9:
              ...
              result = [];
              ethPrice = bignumber.BigNumber.from(0);
              _context6.prev = 12;
              _context6.next = 15;
                    ...
                    while (1) {
                      switch (_context5.prev = _context5.next) {
                        case 0:
                          ...
                          plan = new AggSwapPlan([item.route], amount, fromToken.chainId);
                          _context5.next = 5;
                          return AggRouter.swap(plan, wallet, exports.CallMode.ESTIMATE_GAS);
            ...
            case 25:
              ...
              for (i = 0; i < gasResults.length; i++) {
                ...
                if (temp.status == 'fulfilled') {
                  ...
                  gasFeeByToToken = gasFee.mul(ethPrice).div(bignumber.BigNumber.from(10).pow(18));
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 21:
              ...
              for (_iterator10 = _createForOfIteratorHelperLoose(routes); !(_step10 = _iterator10()).done;) {
                ...
                _loop5 = function _loop5() {
                  ...
                  if (dex != null && dex.type == exports.DexType.UniswapV2) {
                  ...
                  } else if (dex != null && dex.type == exports.DexType.Acryptos) {
            ...
            case 42:
              ...
              _context7.next = 46;
              return this.aggPairRouteOutputAmount(_route.route, fromToken, bignumber.BigNumber.from(inputAmount), OUTPUT_CACHE);
            ...
            case 50:
              ...
              return _context7.abrupt("return", tempResult.map(function (t) {
                ...
                for (var _iterator12 = _createForOfIteratorHelperLoose(t.route), _step12; !(_step12 = _iterator12()).done;) {
                  ...
                  !(_dex != null) ?    invariant(false)    : void 0;
                  das.push([new DexAssign(_dex, 100)]);
                }

                tokens.push(AggTokenGraph.copyToken(nextFromToken));
                return {
                  route: new AggSwapRoute(bignumber.BigNumber.from(inputAmount), tokens, das),
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              ...
              return _context8.abrupt("return", bignumber.BigNumber.from(0));
            ...
            case 7:
              ...
              _context8.next = 15;
              return ACryptoS.getBestTradeExactInStatic(tokenIn, units.formatUnits(inputAmount, inputToken.decimals), tokenOut, dexFactory, curvePool);

            case 15:
              trade = _context8.sent;
              console.timeEnd("query Acryptos price");
              return _context8.abrupt("return", bignumber.BigNumber.from(trade.outputAmount.raw.toString()));
  ...
  AggTokenGraph.aggPairAnother = function aggPairAnother(aggPair, token) {
    !this.aggPairContainsToken(token, aggPair) ?  invariant(false)  : void 0;
  ...
  _proto.aggPairOutputAmountStatic = function aggPairOutputAmountStatic(aggPair, inputToken, inputAmount) {
    ...
    if (dexFactory == null) return bignumber.BigNumber.from(0);
    var inputReserve = bignumber.BigNumber.from(aggPair.token0.address == inputToken.address ? aggPair.reserve0 : aggPair.reserve1);
    var outputReserve = bignumber.BigNumber.from(aggPair.token0.address == inputToken.address ? aggPair.reserve1 : aggPair.reserve0);
    if (inputReserve.eq(0) || outputReserve.eq(0)) return bignumber.BigNumber.from(0);
    var fee = bignumber.BigNumber.from(1000).sub(dexFactory.baseFee.multiply("1000").toFixed(0));
    if (inputAmount.mul(fee).gte(inputReserve.mul(1000))) return bignumber.BigNumber.from(0);
  ...
  _proto.aggPairPriceImpact = function aggPairPriceImpact(aggPair, inputToken, inputAmount) {
    var inputReserve = bignumber.BigNumber.from(aggPair.token0.address == inputToken.address ? aggPair.reserve0 : aggPair.reserve1);
    var outputReserve = bignumber.BigNumber.from(aggPair.token0.address == inputToken.address ? aggPair.reserve1 : aggPair.reserve0);
    if (inputReserve.eq(0) || outputReserve.eq(0)) return bignumber.BigNumber.from(1000);
    var dexFactory = DexFactory.getDexFactory(aggPair.dexName, aggPair.token0.chainId);
    if (dexFactory == null) return bignumber.BigNumber.from(1000);
    var fee = bignumber.BigNumber.from(1000).sub(dexFactory.baseFee.multiply("1000").toFixed(0));
    if (inputAmount.mul(fee).gte(inputReserve.mul(1000))) return bignumber.BigNumber.from(1000);
    ...
    if (exactQuote.eq(0)) return bignumber.BigNumber.from(1000);
...
var AggPair = function AggPair(dexName, token0, token1, reserve0, reserve1) {
  ...
  !(token0.chainId == token1.chainId) ?  invariant(false, "Chain ID must be same")  : void 0;
  !!token0.equals(token1) ?  invariant(false, "Require different tokens")  : void 0;
  !(DexFactory.getDexFactory(dexName, token0.chainId) != null) ?  invariant(false, "Dex name doesn't exist")  : void 0;
  this.dexName = dexName;

  if (token0.sortsBefore(token1)) {
    this.token0 = token0;
    this.reserve0 = bignumber.BigNumber.from(reserve0);
    this.token1 = token1;
    this.reserve1 = bignumber.BigNumber.from(reserve1);
  } else {
    this.token1 = token0;
    this.reserve1 = bignumber.BigNumber.from(reserve0);
    this.token0 = token1;
    this.reserve0 = bignumber.BigNumber.from(reserve1);
  }
};

exports.JSBI = JSBI;
exports.ADDRESS_NULL = ADDRESS_NULL;
exports.ADDRESS_ZERO = ADDRESS_ZERO;
exports.AggPair = AggPair;
exports.AggRouter = AggRouter;
exports.AggRouterSwapParameter = AggRouterSwapParameter;
exports.AggSwapPlan = AggSwapPlan;
exports.AggSwapRoute = AggSwapRoute;
exports.AggTokenGraph = AggTokenGraph;
exports.ArbiPlan = ArbiPlan;
exports.ArbiUtil = ArbiUtil;
exports.ChainConfig = ChainConfig;
exports.ChangeModel = ChangeModel;
exports.Currency = Currency;
exports.CurrencyAmount = CurrencyAmount;
exports.DexAssign = DexAssign;
exports.DexFactory = DexFactory;
exports.DexTrade = DexTrade;
exports.ETHER = ETHER;
...
exports.NewHarborRouterUtil = NewHarborRouterUtil;
exports.ONE_HUNDRED_PERCENT = ONE_HUNDRED_PERCENT;
exports.PERCENT_02 = PERCENT_02;
exports.PERCENT_025 = PERCENT_025;
exports.PERCENT_03 = PERCENT_03;
exports.PERCENT_035 = PERCENT_035;
exports.PERCENT_05 = PERCENT_05;
exports.PERCENT_1 = PERCENT_1;
exports.PERCENT_2 = PERCENT_2;
exports.PERCENT_3 = PERCENT_3;
exports.Pair = Pair;
exports.PairUtil = PairUtil;
exports.Percent = Percent;
exports.Price = Price;
exports.PriceUtil = PriceUtil;
exports.ProviderUtil = ProviderUtil;
exports.Route = Route;
exports.Router = Router;
exports.ScanUtil = ScanUtil;
exports.SearchChanceJsonData = SearchChanceJsonData;
exports.SwapRouteParameter = SwapRouteParameter;
exports.SwapUtil = SwapUtil;
exports.Token = Token;
exports.TokenAmount = TokenAmount;
exports.TokenInTradingError = TokenInTradingError;
...
exports.Web3WalletWrapper = Web3WalletWrapper;
